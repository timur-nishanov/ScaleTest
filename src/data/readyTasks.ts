 ...
 * (экран «Выбрать из готового», file uQ5AOTiVFp6NILcvOLIMly → 11:3515).
 *
 * type/title/cardDesc сверены 1:1 с макетами (design context, 25.08).
 * Экран бандлов отрисован в макете только для задачи rtdash — её тексты бандлов
 * совпали с прототипом дословно, поэтому бандлы остальных задач оставлены из
 * прототипа до финальных текстов YC. TODO(bundle-texts)
...
export const READY_TASKS: ReadyTask[] = [
  ...
  },
  {
    ...
    // Текст «Задания» из макета (11:2265):
    assignment:
