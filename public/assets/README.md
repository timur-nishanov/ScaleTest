...
**Не хватает:** иллюстрации попапов результата (`popup-*`), иконка баннера монеты (`coin-circle`). Всё остальное (логотип, kv-иллюстрации карточек, композиции режимов, шевроны, кубик) — на месте.
